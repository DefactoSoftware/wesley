export default {
  ...
  'instructions': {
    ...
    'ul1': '<ul><li>Levensverlenging <br>Streven naar zo lang mogelijk leven.</li><li>Onafhankelijkheid bewaren <br>Streven naar zo groot mogelijke zelfredzaamheid in het dagelijks leven</li><li>Verminderen of wegnemen van pijn <br>Streven naar een situatie waarin de patiënt zo min mogelijk pijn ervaart.</li><li>Verminderen of wegnemen van andere klachten of symptomen <br>Streven naar een situatie waarin de patiënt zo min mogelijk last heeft van een ander symptoom. Hierbij is van belang dat een patiënt aangeeft om welk symptoom het gaat. Dat kan bijvoorbeeld duizeligheid, misselijkheid, kortademigheid of jeuk zijn.</li></ul>',
  ...
  'video': {
    'introduction': 'In het onderstaande filmpje ziet u een voorbeeld van een gesprek waarin de OPT wordt gebruikt. In dit voorbeeld wordt de OPT toegepast bij een oudere patiënt die veel verschillende medicijnen gebruikt.',
  ...
  'prom': {
    ...
    'li1': '<li><a href="assets/13-NTvG-medicatie-voorkeuren.pdf">Download het artikel</a></li><li><a href="assets/poster-prom-2014.pdf">Download de poster (2014)</a></li><li><a href="assets/poster-prom-2015.pdf">Download de poster (2015)</a></li><li>Het eerste artikel over het schuifje getiteld “Eliciting preferences of multimorbid elderly adults in family practice using an outcome prioritization tool” is inmiddels gepubliceerd in de Journal American Geriatrics Society (JAGS) 2016 doi 10.1111/jgs.14415. In dit artikel worden de ervaringen met het schuifje tijdens medicatie review van zowel patiënten als huisartsen beschreven. Hieronder vindt u het abstract van, wilt u het gehele artikel lezen dan kunt u het artikel downloaden via de JAGS website of een mail sturen naar <a href="mailto:j.j.g.t.van.summeren@umcg.nl">j.j.g.t.van.summeren@umcg.nl</a>.</li>'
  },
  'option': {
    'p1': 'De afdeling huisartsgeneeskunde van het UMCG doet onderzoek naar het gebruik van de OPT. Oudere patiënten (≥ 60 jaar) uit ziekenhuizen in het noorden van Nederland die net te horen hebben gekregen dat ze (waarschijnlijk) een ongeneeslijke kanker hebben, kunnen meedoen. Ze worden door loting in twee groepen verdeeld. De ene groep ontvangt zorg zoals altijd, de andere groep heeft gesprekken met de huisarts waarin de OPT wordt gebruikt.',
    'information': '<li><a href="assets/option-informatiefolder.docx" target="_blank">Informatie voor patiënten</a></li><li><a href="assets/option-algemene-huisartseninformatie.docx" target="_blank">Informatie voor huisartsen</a></li><li><a href="assets/option-algemene-specialisteninformatie.docx" target="_blank">Toelichting voor specialisten</a></li>',
    'nieuwsbrieven': '<li><a href="assets/Nieuwsbrief-oktober-2016.pdf" target="_blank">Nieuwsbrief oktober 2016</a><li><a href="assets/Nieuwsbrief-OPTion-studie mei2016.pdf" target="_blank">Nieuwsbrief mei 2016</a><li><a href="assets/Nieuwsbrief-jan2016-2601.pdf" target="_blank">Nieuwsbrief januari 2016</a></li><li><a href="assets/Nieuwsbrief-juli2017.pdf" target="_blank">Nieuwsbrief juli 2017</a></li><li><a href="assets/Nieuwsbrief-dec2017.pdf" target="_blank">Nieuwsbrief-dec2017.pdf</a></li>',
    'li1': 'Uitgebreid voorbeeld OPTion interventie',
    'publications': '<li><a href="assets/Abstract-Maturitas.pdf">Abstract publicatie Maturitas</a></li><li><a href="assets/poster-capri-2016.pdf">Poster CaPRI congres 2016</a></li>',
    'team': 'Het OPTion projectteam bestaat uit:',
    'ul2': '<li>Mw. Drs. M.E. (Mariken) Stegmann, aios Huisartsgeneeskunde en promovenda</li><li>Ms. Dr A.J. (Annette) Berendsen, huisarts en projectleider</li><li>Dhr. Dr. T.J.N. (Jeroen) Hiltermann, long-oncoloog UMCG</li><li>Mw. Dr. A.K.L. (An) Reyners, internist-oncoloog UMCG</li><li>Mr. Dr J. Schuling (Jan), oud-huisarts en onderzoeker</li><li>Dhr. Drs. P. (Pim) Brandenbarg, onderzoeker en onderzoeksmedewerker</li>',
    'contact': 'Contactinformatie',
    'ul3': '<li>Tel: <a href="tel:06 155 25 388">06 155 25 388</a></li><li>Fax: 050 363 2964 (t.n.v. OPTion)</li><li><a href="mailto:option-studie@umcg.nl">option-studie@umcg.nl</a></li><li><a href="http://www.huisartsgeneeskunde-umcg.nl/option" target="_blank">Option bij UMCG</a></li>'
  }
};
