export default {
  ...
  'prom': {
    ...
    'li1': '<li><a href="assets/13-NTvG-medicatie-voorkeuren.pdf">Download het artikel</a></li><li><a href="assets/Poster.ppt">Download de poster</a></li>'
  },
  'option': {
    ...
    'ul1': '<li><a href="assets/option-algemene-specialisteninformatie.pdf" target="_blank">Toelichting voor specialisten</a></li><li><a href="assets/option-algemene-huisartseninformatie.pdf" target="_blank">Informatie voor huisartsen</a></li><li><a href="assets/option-informatie-patienten.pdf" target="_blank">Informatie voor patiënten</a></li>',
